...
revoke execute on function public.pt(integer, integer, integer) from public, anon, authenticated;
revoke execute on function public.pw(integer, integer[], integer[], boolean) from public, anon, authenticated;
revoke execute on function public.pm(integer[], integer[], integer[], integer[], boolean) from public, anon, authenticated;
revoke execute on function public.pz() from public, anon, authenticated;
revoke execute on function public.pc() from public, anon, authenticated;
